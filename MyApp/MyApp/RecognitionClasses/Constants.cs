namespace MyApp.RecognitionClasses
{
    ...
    {
        #region Constants
        public const string ComputerVisionEndpoint = "https://cv281019.cognitiveservices.azure.com/";
        public const string ComputerVisionKey = "6ea90a98aa4d4829a93ef16a2e280380";
        public const string SpeechKey = "b7ae8e587d1f4026943894d0e618761e";
        ...
        public const string GAuthProjectId = "elite-contact-269918";
        public const string GAuthPrivateKeyId = "5d92934e4187f38df0ca58bc8679164da28f3e23";
        public const string GAuthPrivateKey = "-----BEGIN PRIVATE KEY-----\nMIIEvAIBADANBgkqhkiG9w0BAQEFAASCBKYwggSiAgEAAoIBAQDISnpA" +
          ...
          public const string GAuthClientEmail = "iseeapp@elite-contact-269918.iam.gserviceaccount.com";
          public const string GAuthClientId = "110715543981285850074";
          public const string GAuthAuthUri = "https://accounts.google.com/o/oauth2/auth";
          public const string GAuthTokenUri = "https://oauth2.googleapis.com/token";
          public const string GAuthauthProviderUrl = "https://www.googleapis.com/oauth2/v1/certs";
          public const string GAuthClientUrl = "https://www.googleapis.com/robot/v1/";
        #endregion
    }
}
