...
using MyApp.Models.AboutUs;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace MyApp.ViewModels.AboutUs
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:MyApp.ViewModels.AboutUs.AboutUsViewModel"/> class.
        /// </summary>
